  ...
  return (
    <React.Fragment>
      ...
      <Typography gutterBottom variant="h1">
        Say{' '}
        <Box
          href="mailto:hi@kevinolsson.com"
          underline="always"
          component={Link}
        >
          {' '}
      ...
      <Box maxWidth={640}>
        ...
        <Typography variant="body1" paragraph>
          ...
          reaching out!I love building things so I am always open for small side
          projects. Alternatively, my friends at{' '}
          <Link href="https://kirigami.co/" underline="always" color="primary">
            Kirigami
          </Link>{' '}
