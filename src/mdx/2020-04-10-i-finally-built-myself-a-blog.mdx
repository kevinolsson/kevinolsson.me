...
A good friend of mine always loved comparing a web developer who doesn't have a website to a mechanic who drives around with a shitty car. _"He's probably too busy taking care of other people's car to put time into his own."_
...
NetlifyCMS does not have a starter with _just_ React (ala create-react-app). I wasn't exactly interested in dealing with Gatsby or Preact right now hence another reason for the starter I mentioned above.
