...
There's still a laundry list of things to do for this site. I think the 2 biggest right now is dark mode (cause fun) and heavier focus on accessibility (may not sound fun, but inclusivity is important! _ - says the guy using emojis left and right_).
